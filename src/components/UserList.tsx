...
function UserList() {
  ...
  // Eğer backend tek bir obje içinde liste dönüyorsa (ListResponseModel) response.data kullanılır.
  // Eğer direkt liste dönüyorsa response kullanılır. Senin yapına göre response.data diyorum.
